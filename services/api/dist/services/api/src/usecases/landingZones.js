...
export async function getLandingZone(zoneId) {
...
export async function updateLandingZone(zoneId, data) {
...
export async function deleteLandingZone(zoneId) {
...
export async function getLandingZoneToken(zoneId) {
    const zone = await prisma.landingZone.findUnique({
        where: { id: zoneId },
